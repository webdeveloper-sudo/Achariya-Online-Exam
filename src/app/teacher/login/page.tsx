...
import { Lock, Mail, ArrowLeft, BookOpen, AlertCircle, HelpCircle, Eye, EyeOff } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field pl-12 pr-11 py-3 bg-white text-gray-900 placeholder-gray-400"
                  placeholder="••••••••"
                />
                <button
                  type="button"
