...
export async function GET(request: Request) {
  try {
    ...
    // Fetch director live sessions conducted
    const sessions = await prisma.directorLiveSession.findMany({
      where: decoded.role === "Admin" ? {} : { directorId: decoded.id },
    ...
    console.error("Error retrieving director live sessions:", error);
    return NextResponse.json(
