...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `
Create a clean, professional, and educational SVG diagram representing the visual context for this teacher evaluation exam question:
"${questionText}"
...
3. The SVG must:
   ...
   - Look professional, modern, and high-contrast for an educational leadership evaluation paper.
`.trim();
